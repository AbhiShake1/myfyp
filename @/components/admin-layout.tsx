 ...
 * @see https://v0.dev/t/GVtMF513hIQ
 */
...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const activeStyle = "flex items-center gap-3 rounded-lg px-3 py-2 text-gray-900 bg-gray-200 transition-all hover:text-gray-900 dark:text-gray-50 dark:bg-gray-700 dark:hover:text-gray-50";
